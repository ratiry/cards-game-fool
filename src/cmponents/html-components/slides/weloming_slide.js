function Welcoming_slide(){
  return(
    <div className="welcoming-slide slide">
      <div className='starter-button-container'>
        <button id="starter_button" className="starter-button">одиночная игра</button>
        <div className='img-start-game'></div>
      </div>
      <div className='leadership-button-container'>
        <button className="leaderboard-button" id="leaderboard_button">
...
export default Welcoming_slide; 